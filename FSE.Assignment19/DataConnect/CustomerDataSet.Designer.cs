...
namespace FSE.Assignment19.DataConnect {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(string Name, string Address, System.DateTime DOB, int Salary) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public int Salary {
                get {
                    try {
                        return ((int)(this[this.tableCustomers.SalaryColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace FSE.Assignment19.DataConnect.CustomerDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Name], [Address], [DOB], [Salary]) VALUES (@Name," +
                " @Address, @DOB, @Salary)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [Name] = @Name, [Address] = @Address, [DOB] = @DOB, " +
                "[Salary] = @Salary WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["Assignment19"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Address, DOB, Salary FROM dbo.Customers";
        ...
        public virtual int Insert(string Name, string Address, global::System.Nullable<global::System.DateTime> DOB, global::System.Nullable<int> Salary) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Address, global::System.Nullable<global::System.DateTime> DOB, global::System.Nullable<int> Salary, int Original_Id) {
            if ((Name == null)) {
